...
TEST(Module04Ex02AbstractIntegrationTest, MainProgramExercisesConcreteAnimalsAndDeepCopyOutput) {
    const test_support::ProcessResult result =
        test_support::run_process(MODULE04_EX02_APP_PATH, std::vector<std::string>());
